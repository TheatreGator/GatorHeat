...
def build_figure(merged_df, view_filter, metric_choice, marker_size, stalls_bottom, dress_bottom, has_r, has_p, has_v, title_override=None):
    ...
    # Updated hovermode and selection options
...
if not df_sales.empty:
    ...
    if perf_col != "None":
        ...
        # Auto-update performance count based on selection
    ...
    with tab_map:
        ...
        # Enable Interactive Plotly Event Listening
        event = st.plotly_chart(final_fig, use_container_width=True, on_select="rerun", selection_mode=('box', 'lasso', 'select'))
