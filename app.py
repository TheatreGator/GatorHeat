...
def build_figure(merged_df, view_filter, metric_choice, marker_size, stalls_bottom, dress_bottom, has_r, has_p, has_v, title_override=None):
    ...
    fig.update_layout(
        plot_bgcolor='white', 
        autosize=True,
        margin=dict(l=10, r=10, b=10, t=50 if title_override else 10),
        yaxis=dict(autorange='reversed', showgrid=False, zeroline=False, visible=False, scaleanchor="x", scaleratio=1), 
