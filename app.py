...
if not df_sales.empty:
    ...
    with tab_map:
        ...
        # Build the final static figure to use for HTML export
        ...
        # HTML Export Button logic
        with c_anim2 if date_col != "None" else c_anim1:
            html_string = final_fig.to_html(full_html=True, include_plotlyjs='cdn')
            st.download_button(
                label="🔗 Download Shareable Interactive Map (HTML)",
                data=html_string,
                file_name="alhambra_interactive_heatmap.html",
                mime="text/html",
                help="Download this map as a standalone webpage to email or share with your team. They can view and hover, but cannot edit."
            )
        ...
        if play_btn and min_date and max_date:
            ...
            map_placeholder.plotly_chart(final_fig, use_container_width=True)
