...
def get_heatmap_color(count, max_count):
    ...
    # Updated for modern Matplotlib compatibility
...
def build_theatre_layout():
    ...
    for row_letter, num_seats in dress_rows:
        ...
        # Fix the seat numbers for the right block
...
if not df_sales.empty:
    ...
    if st.button("Generate Overlay Heatmap"):
        ...
        # Ensure layout columns are explicitly cast as strings to prevent ValueError
        df_layout['Area'] = df_layout['Area'].astype(str)
